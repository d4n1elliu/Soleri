    ...
    <section className="rounded-2xl bg-zinc-900 p-4 ring-1 ring-zinc-800 sm:p-7">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {phases.map((phase) => {
          ...
          return (
            <div key={phase.artistId} className="rounded-lg bg-zinc-800 p-4">
              <div className="flex items-center gap-3">
                {image ? (
                  ...
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-zinc-700 text-base font-bold text-green-400">
              ...
              <div className="relative mt-4 h-1.5 rounded-full bg-zinc-700">
                <div
